...
// overrides the default create behavior to attach the currently logged-in user to the activity log entry
...
export default factories.createCoreController('api::activity-log.activity-log', ({ strapi }) => ({
    async create(ctx) {
        ...
        body.users_permissions_user = user.id // insert the user id
